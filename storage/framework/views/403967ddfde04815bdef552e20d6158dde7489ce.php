...
<html>
    <head>
        <script> 
        const REGISTER_ROUTE_URL = "<?php echo e(route('register')); ?>";
        </script>
...
<body>
    <main>
        <div id=container> 
            <div id='immagine'> <img src="<?php echo e(url('images/signup_back.jpg')); ?>" /> </div>
            ...
            <div id='form'>
                <form name='signup' method='post' action="<?php echo e(route('register')); ?>">
                    ...
                    <div class="signup">Hai un account? <a href="<?php echo e(route('login')); ?>"> Accedi</a> </div>
                </form>
            </div>
        </div>
    </main>
</body>
</html><?php /**PATH C:\Users\feder\XAMPP\htdocs\hw2\resources\views/register.blade.php ENDPATH**/ ?>